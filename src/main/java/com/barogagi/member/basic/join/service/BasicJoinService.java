...
public class BasicJoinService {
    ...
    public ApiResponse checkNickname(String apiSecretKey, String nickname) {
        ...
        return ApiResponse.result(
                ProcessResultCode.AVAILABLE_NICKNAME.getResultCode(),
                ProcessResultCode.AVAILABLE_NICKNAME.getMessage()
        );
    }
    ...
    public ApiResponse checkUserId(String apiSecretKey, String userId) {
        ...
        return ApiResponse.result(
                ProcessResultCode.AVAILABLE_USER_ID.getResultCode(),
                ProcessResultCode.AVAILABLE_USER_ID.getMessage()
        );
    }
    ...
    public ApiResponse signUp(JoinRequestDTO joinRequestDTO) {
        ...
        if(insertResult <= 0){
            throw new JoinException(
                    ProcessResultCode.FAIL_SIGN_UP.getResultCode(),
                    ProcessResultCode.FAIL_SIGN_UP.getMessage()
            );
        }

        return ApiResponse.result(
                ProcessResultCode.SUCCESS_SIGN_UP.getResultCode(),
                ProcessResultCode.SUCCESS_SIGN_UP.getMessage()
        );
    }
    ...
    public ApiResponse deleteAccount(RefreshTokenRequestDTO refreshTokenRequestDTO) {
        ...
        if(deleteResult <= 0) {
            throw new JoinException(
                    ProcessResultCode.FAIL_DELETE_ACCOUNT.getResultCode(),
                    ProcessResultCode.FAIL_DELETE_ACCOUNT.getMessage()
            );
        }

        return ApiResponse.result(
                ProcessResultCode.SUCCESS_DELETE_ACCOUNT.getResultCode(),
                ProcessResultCode.SUCCESS_DELETE_ACCOUNT.getMessage()
        );
    }
}
