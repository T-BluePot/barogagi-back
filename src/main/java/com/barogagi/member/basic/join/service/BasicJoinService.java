...
public class BasicJoinService {
    ...
    public ApiResponse existsByNickname(String apiSecretKey, String nickname) {
        ...
        // 4. 닉네임 중복 체크
        boolean existsNickname = joinService.existsByNickName(nickname);
        if(existsNickname) {
    ...
    public ApiResponse existsByUserId(String apiSecretKey, String userId) {
        ...
        // 4. 아이디 중복 체크
        boolean existsByUserId = joinService.existsByUserId(userId);
    ...
    public ApiResponse withdrawMember(RefreshTokenRequestDTO refreshTokenRequestDTO) {
