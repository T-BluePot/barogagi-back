...
public class ApprovalService {
    ...
    public ApiResponse approvalTelSend(@RequestBody ApprovalSendVO approvalSendVO) {
        ...
        try {
            ...
            if(sendMessageResult){
                ...
                if(insertResult > 0) {
                    resultCode = ProcessResultCode.SUCCESS_SEND_SMS.getResultCode();
                    message = ProcessResultCode.SUCCESS_SEND_SMS.getMessage();
                } else{
                    resultCode = ProcessResultCode.ERROR_SEND_SMS.getResultCode();
                    message = ProcessResultCode.ERROR_SEND_SMS.getMessage();
                }
            } else {
                resultCode = ProcessResultCode.FAIL_SEND_SMS.getResultCode();
                message = ProcessResultCode.FAIL_SEND_SMS.getMessage();
            }
    ...
    public ApiResponse approvalTelCheck(ApprovalCompleteVO approvalCompleteVO) {
        ...
        try {
            ...
            if(updateResult == 1){
                resultCode = ProcessResultCode.SUCCESS_CHECK_SMS.getResultCode();
                message = ProcessResultCode.SUCCESS_CHECK_SMS.getMessage();
            } else {
                resultCode = ProcessResultCode.FAIL_CHECK_SMS.getResultCode();
                message = ProcessResultCode.FAIL_CHECK_SMS.getMessage();
            }
